    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} className="flex flex-col gap-3">
        ...
        <div className="flex justify-center gap-3">
          {/* Google */}
          <button type="button" className="w-9 h-9 rounded-full border-none bg-transparent cursor-pointer flex items-center justify-center transition-transform duration-200 p-0 hover:scale-110">
