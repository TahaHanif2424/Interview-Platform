    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs font-medium text-secondary ml-1">Email</label>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="relative flex items-center">
            ...
            >
              {showPassword ? (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 text-text-light">
        ...
        <div className="text-right -mt-1">
          <a href="#" className="text-xs text-secondary font-medium no-underline hover:text-accent">
            Forgot Password?
          </a>
        </div>
        ...
        <div className="flex justify-center gap-3">
          {/* Google */}
          <button type="button" className="w-10 h-10 rounded-full border-none bg-transparent cursor-pointer flex items-center justify-center transition-transform duration-200 p-0 hover:scale-110">
            <svg viewBox="0 0 24 24" className="w-7 h-7">
              ...
              <path fill="#374151" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
              <path fill="#374151" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
              <path fill="#1F2933" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
            </svg>
          </button>
          ...
          <button type="button" className="w-10 h-10 rounded-full border-none bg-transparent cursor-pointer flex items-center justify-center transition-transform duration-200 p-0 hover:scale-110">
            <svg viewBox="0 0 24 24" className="w-7 h-7">
              ...
              <path fill="#F9FAFB" d="M15.5 8.5h-2c-.5 0-1 .5-1 1v2h3l-.5 3h-2.5v6h-3v-6H7v-3h2.5v-2.5c0-2 1.5-3.5 3.5-3.5h2.5v3z"/>
            </svg>
          </button>
